...
var _View_Navbar_Host0 = (function (_super) {
    ...
    function _View_Navbar_Host0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_Navbar_Host0, renderType_Navbar_Host, import7.ViewType.HOST, viewUtils, parentInjector, declarationEl, import1.ChangeDetectorStatus.CheckAlways);
    }
    _View_Navbar_Host0.prototype.createInternal = function (rootSelector) {
        ...
        this._Navbar_0_4 = new Wrapper_Navbar(this.parentInjector.get(import8.App), this.parentInjector.get(import9.ViewController, null), this.parentInjector.get(import10.NavController, null), this.parentInjector.get(import11.Config), new import12.ElementRef(this._el_0), this.renderer);
...
export var NavbarNgFactory = new import14.ComponentFactory('ion-navbar', viewFactory_Navbar_Host0, import0.Navbar);
var styles_Navbar = [];
...
var _View_Navbar0 = (function (_super) {
    ...
    function _View_Navbar0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_Navbar0, renderType_Navbar, import7.ViewType.COMPONENT, viewUtils, parentInjector, declarationEl, import1.ChangeDetectorStatus.CheckAlways);
    }
    _View_Navbar0.prototype.createInternal = function (rootSelector) {
        ...
        this._appEl_1 = new import5.AppElement(1, null, this, this._el_1);
        var compView_1 = import17.viewFactory_Button0(this.viewUtils, this.injector(1), this._appEl_1);
        ...
        this._Button_1_5 = new import17.Wrapper_Button(null, 'bar-button', this.parentInjector.get(import11.Config), new import12.ElementRef(this._el_1), this.renderer);
    ...
    _View_Navbar0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import21.NgClass) && (0 === requestNodeIndex))) {
            return this._NgClass_0_3.context;
        }
        if (((token === import21.NgClass) && (3 === requestNodeIndex))) {
            return this._NgClass_3_3.context;
        }
        if (((token === import22.Icon) && (3 === requestNodeIndex))) {
            return this._Icon_3_4.context;
        }
        if (((token === import21.NgClass) && (4 === requestNodeIndex))) {
            return this._NgClass_4_3.context;
        }
        if (((token === import21.NgClass) && ((1 <= requestNodeIndex) && (requestNodeIndex <= 4)))) {
            return this._NgClass_1_4.context;
        }
        if (((token === import23.Button) && ((1 <= requestNodeIndex) && (requestNodeIndex <= 4)))) {
            return this._Button_1_5.context;
        }
        if (((token === import21.NgClass) && (5 === requestNodeIndex))) {
