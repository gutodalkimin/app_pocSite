...
import * as import0 from 'ionic-angular/components/spinner/spinner';
...
export var Wrapper_Spinner = (function () {
    function Wrapper_Spinner(p0, p1, p2) {
        ...
        this._duration = import1.UNINITIALIZED;
        this._paused = import1.UNINITIALIZED;
    ...
    Wrapper_Spinner.prototype.check_duration = function (currValue, throwOnChange, forceUpdate) {
        if ((forceUpdate || import2.checkBinding(throwOnChange, this._duration, currValue))) {
            this.changed = true;
    ...
    Wrapper_Spinner.prototype.check_paused = function (currValue, throwOnChange, forceUpdate) {
        if ((forceUpdate || import2.checkBinding(throwOnChange, this._paused, currValue))) {
            this.changed = true;
...
var _View_Spinner_Host0 = (function (_super) {
    ...
    function _View_Spinner_Host0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_Spinner_Host0, renderType_Spinner_Host, import7.ViewType.HOST, viewUtils, parentInjector, declarationEl, import1.ChangeDetectorStatus.CheckAlways);
    }
    _View_Spinner_Host0.prototype.createInternal = function (rootSelector) {
        ...
        this._Spinner_0_4 = new Wrapper_Spinner(this.parentInjector.get(import8.Config), new import9.ElementRef(this._el_0), this.renderer);
...
export var SpinnerNgFactory = new import11.ComponentFactory('ion-spinner', viewFactory_Spinner_Host0, import0.Spinner);
var styles_Spinner = [];
...
var _View_Spinner0 = (function (_super) {
    ...
    function _View_Spinner0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_Spinner0, renderType_Spinner, import7.ViewType.COMPONENT, viewUtils, parentInjector, declarationEl, import1.ChangeDetectorStatus.CheckOnce);
    }
    _View_Spinner0.prototype.createInternal = function (rootSelector) {
        ...
        this._NgFor_0_6 = new import12.Wrapper_NgFor(this._appEl_0.vcRef, this._TemplateRef_0_5, this.parentInjector.get(import14.IterableDiffers), this.ref);
    ...
    _View_Spinner0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import15.NgFor) && (1 === requestNodeIndex))) {
...
var _View_Spinner1 = (function (_super) {
    ...
    function _View_Spinner1(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_Spinner1, renderType_Spinner, import7.ViewType.EMBEDDED, viewUtils, parentInjector, declarationEl, import1.ChangeDetectorStatus.CheckAlways);
    }
    ...
    _View_Spinner1.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import18.NgStyle) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) {
...
var _View_Spinner2 = (function (_super) {
    ...
    function _View_Spinner2(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_Spinner2, renderType_Spinner, import7.ViewType.EMBEDDED, viewUtils, parentInjector, declarationEl, import1.ChangeDetectorStatus.CheckAlways);
    }
