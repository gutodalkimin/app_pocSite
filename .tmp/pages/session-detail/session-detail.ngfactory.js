...
export var Wrapper_SessionDetailPage = (function () {
    function Wrapper_SessionDetailPage(p0) {
        this.changed = false;
        this.context = new import0.SessionDetailPage(p0);
    }
    Wrapper_SessionDetailPage.prototype.detectChangesInternal = function (view, el, throwOnChange) {
        var changed = this.changed;
        this.changed = false;
        return changed;
    };
    return Wrapper_SessionDetailPage;
}());
...
var _View_SessionDetailPage_Host0 = (function (_super) {
    ...
    _View_SessionDetailPage_Host0.prototype.createInternal = function (rootSelector) {
        ...
        this._appEl_0.initComponent(this._SessionDetailPage_0_4.context, [], compView_0);
        compView_0.create(this._SessionDetailPage_0_4.context, this.projectableNodes, null);
        this.init([].concat([this._el_0]), [this._el_0], [], []);
        return this._appEl_0;
    };
    _View_SessionDetailPage_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import0.SessionDetailPage) && (0 === requestNodeIndex))) {
            return this._SessionDetailPage_0_4.context;
        }
        return notFoundResult;
    };
    _View_SessionDetailPage_Host0.prototype.detectChangesInternal = function (throwOnChange) {
...
export var SessionDetailPageNgFactory = new import10.ComponentFactory('page-session-detail', viewFactory_SessionDetailPage_Host0, import0.SessionDetailPage);
...
var _View_SessionDetailPage0 = (function (_super) {
    ...
    _View_SessionDetailPage0.prototype.createInternal = function (rootSelector) {
        ...
        this._text_5 = this.renderer.createText(null, 'Seção', null);
    ...
    _View_SessionDetailPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import30.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 24)))) {
