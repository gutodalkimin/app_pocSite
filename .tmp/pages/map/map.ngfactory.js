...
var _View_MapPage_Host0 = (function (_super) {
    ...
    _View_MapPage_Host0.prototype.createInternal = function (rootSelector) {
        ...
        this._appEl_0.initComponent(this._MapPage_0_4.context, [], compView_0);
        compView_0.create(this._MapPage_0_4.context, this.projectableNodes, null);
    ...
    _View_MapPage_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import0.MapPage) && (0 === requestNodeIndex))) {
            return this._MapPage_0_4.context;
        }
...
export var MapPageNgFactory = new import10.ComponentFactory('page-map', viewFactory_MapPage_Host0, import0.MapPage);
var styles_MapPage = [];
...
var _View_MapPage0 = (function (_super) {
    ...
    _View_MapPage0.prototype.createInternal = function (rootSelector) {
        ...
        this._text_10 = this.renderer.createText(null, 'Mapa', null);
        ...
        this._Content_14_4 = new import19.Wrapper_Content(this.parentInjector.get(import20.Config), new import21.ElementRef(this._el_14), this.renderer, this.parentInjector.get(import23.App), this.parentInjector.get(import27.Keyboard), this.parentInjector.get(import28.NgZone), this.parentInjector.get(import22.ViewController, null), this.parentInjector.get(import29.Tabs, null));
    ...
    _View_MapPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import36.Content) && ((14 <= requestNodeIndex) && (requestNodeIndex <= 17)))) {
