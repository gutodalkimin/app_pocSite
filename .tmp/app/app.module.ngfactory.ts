...
import * as import46 from '../providers/user-data';
import * as import47 from '../providers/conference-data';
...
import * as import58 from '../pages/about/about.ngfactory';
import * as import59 from '../pages/account/account.ngfactory';
import * as import60 from '../pages/login/login.ngfactory';
import * as import61 from '../pages/map/map.ngfactory';
import * as import62 from '../pages/about-popover/about-popover.ngfactory';
import * as import63 from '../pages/schedule/schedule.ngfactory';
import * as import64 from '../pages/schedule-filter/schedule-filter.ngfactory';
import * as import65 from '../pages/session-detail/session-detail.ngfactory';
import * as import66 from '../pages/signup/signup.ngfactory';
import * as import67 from '../pages/speaker-detail/speaker-detail.ngfactory';
import * as import68 from '../pages/speaker-list/speaker-list.ngfactory';
import * as import69 from '../pages/tabs/tabs.ngfactory';
import * as import70 from '../pages/tutorial/tutorial.ngfactory';
...
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  __UserData_76:import46.UserData;
  __ConferenceData_77:import47.ConferenceData;
  constructor(parent:import48.Injector) {
    super(parent,[
      ...
      import57.ConferenceAppNgFactory,
      import57.ConferenceAppNgFactory,
      import58.AboutPageNgFactory,
      import59.AccountPageNgFactory,
      import60.LoginPageNgFactory,
      import61.MapPageNgFactory,
      import62.PopoverPageNgFactory,
      import63.SchedulePageNgFactory,
      import64.ScheduleFilterPageNgFactory,
      import65.SessionDetailPageNgFactory,
      import66.SignupPageNgFactory,
      import67.SpeakerDetailPageNgFactory,
      import68.SpeakerListPageNgFactory,
      import69.TabsPageNgFactory,
      import70.TutorialPageNgFactory,
      import51.IonicAppNgFactory
    ]
    ,[import51.IonicAppNgFactory]);
  }
  ...
  get _APP_ID_29():any {
    if ((this.__APP_ID_29 == (null as any))) { (this.__APP_ID_29 = import71._appIdRandomProviderFactory()); }
  ...
  get _EVENT_MANAGER_PLUGINS_32():any[] {
    if ((this.__EVENT_MANAGER_PLUGINS_32 == (null as any))) { (this.__EVENT_MANAGER_PLUGINS_32 = [
      ...
      new import74.HammerGesturesPlugin(this._HAMMER_GESTURE_CONFIG_31)
    ]
    ); }
    return this.__EVENT_MANAGER_PLUGINS_32;
  }
  get _EventManager_33():import16.EventManager {
    if ((this.__EventManager_33 == (null as any))) { (this.__EventManager_33 = new import16.EventManager(this._EVENT_MANAGER_PLUGINS_32,this.parent.get(import75.NgZone))); }
  ...
  get _RootRenderer_37():any {
    if ((this.__RootRenderer_37 == (null as any))) { (this.__RootRenderer_37 = import76._createConditionalRootRenderer(this._DomRootRenderer_36,this.parent.get(import76.NgProbeToken,(null as any)))); }
  ...
  get _AppRootToken_53():any {
    if ((this.__AppRootToken_53 == (null as any))) { (this.__AppRootToken_53 = import77.ConferenceApp); }
  ...
  get _Keyboard_61():import34.Keyboard {
    if ((this.__Keyboard_61 == (null as any))) { (this.__Keyboard_61 = new import34.Keyboard(this._Config_21,this._Form_58,this.parent.get(import75.NgZone))); }
  ...
  get _LocationStrategy_63():any {
    if ((this.__LocationStrategy_63 == (null as any))) { (this.__LocationStrategy_63 = import8.provideLocationStrategy(this.parent.get(import78.PlatformLocation),this.parent.get(import79.APP_BASE_HREF,(null as any)),this._Config_21)); }
  ...
  get _TapClick_69():import41.TapClick {
    if ((this.__TapClick_69 == (null as any))) { (this.__TapClick_69 = new import41.TapClick(this._Config_21,this._App_22,this.parent.get(import75.NgZone))); }
  ...
  get _UrlSerializer_73():any {
    if ((this.__UrlSerializer_73 == (null as any))) { (this.__UrlSerializer_73 = import80.setupUrlSerializer(this._DeepLinkConfigToken_54)); }
    return this.__UrlSerializer_73;
  }
  get _DeepLinker_74():any {
    if ((this.__DeepLinker_74 == (null as any))) { (this.__DeepLinker_74 = import81.setupDeepLinker(this._App_22,this._UrlSerializer_73,this._Location_64)); }
  ...
  get _UserData_76():import46.UserData {
    if ((this.__UserData_76 == (null as any))) { (this.__UserData_76 = new import46.UserData(this._Events_57,this._Storage_75)); }
    return this.__UserData_76;
  }
  get _ConferenceData_77():import47.ConferenceData {
    if ((this.__ConferenceData_77 == (null as any))) { (this.__ConferenceData_77 = new import47.ConferenceData(this._Http_50,this._UserData_76)); }
    return this.__ConferenceData_77;
  }
  createInternal():import1.AppModule {
    ...
    this._QueryParams_14 = import82.setupQueryParams(this._UrlToken_13);
    this._PlatformConfigToken_15 = import83.providePlatformConfigs();
    ...
    this._Platform_20 = import84.setupPlatform(this._PlatformConfigToken_15,this._QueryParams_14,this._UserAgentToken_16,this._NavigatorPlatformToken_17,this._DocumentDirToken_18,this._DocLangToken_19,this.parent.get(import75.NgZone));
    this._Config_21 = import85.setupConfig(this._ConfigToken_12,this._QueryParams_14,this._Platform_20);
    this._App_22 = new import10.App(this._Config_21,this._Platform_20);
    this._APP_INITIALIZER_23 = [
      import86.registerModeConfigs(this._Config_21),
      import87.registerTransitions(this._Config_21),
      import30.setupProvideEvents(this._Platform_20),
      import41.setupTapClick(this._Config_21,this._App_22,this.parent.get(import75.NgZone))
    ]
    ;
    this._ApplicationInitStatus_24 = new import11.ApplicationInitStatus(this._APP_INITIALIZER_23);
    this._Testability_25 = new import12.Testability(this.parent.get(import75.NgZone));
    this._ApplicationRef__26 = new import13.ApplicationRef_(this.parent.get(import75.NgZone),this.parent.get(import88.Console),this,this._ErrorHandler_11,this,this._ApplicationInitStatus_24,this.parent.get(import12.TestabilityRegistry,(null as any)),this._Testability_25);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import89.LOCALE_ID)) { return this._LOCALE_ID_9; }
    if ((token === import9.NgLocalization)) { return this._NgLocalization_10; }
    if ((token === import90.ErrorHandler)) { return this._ErrorHandler_11; }
    if ((token === import85.ConfigToken)) { return this._ConfigToken_12; }
    if ((token === import82.UrlToken)) { return this._UrlToken_13; }
    if ((token === import82.QueryParams)) { return this._QueryParams_14; }
    if ((token === import83.PlatformConfigToken)) { return this._PlatformConfigToken_15; }
    if ((token === import84.UserAgentToken)) { return this._UserAgentToken_16; }
    if ((token === import84.NavigatorPlatformToken)) { return this._NavigatorPlatformToken_17; }
    if ((token === import84.DocumentDirToken)) { return this._DocumentDirToken_18; }
    if ((token === import84.DocLangToken)) { return this._DocLangToken_19; }
    if ((token === import84.Platform)) { return this._Platform_20; }
    if ((token === import85.Config)) { return this._Config_21; }
    ...
    if ((token === import71.APP_ID)) { return this._APP_ID_29; }
    if ((token === import91.DOCUMENT)) { return this._DOCUMENT_30; }
    if ((token === import74.HAMMER_GESTURE_CONFIG)) { return this._HAMMER_GESTURE_CONFIG_31; }
    ...
    if ((token === import92.AnimationDriver)) { return this._AnimationDriver_35; }
    if ((token === import18.DomRootRenderer)) { return this._DomRootRenderer_36; }
    if ((token === import93.RootRenderer)) { return this._RootRenderer_37; }
    if ((token === import19.DomSanitizer)) { return this._DomSanitizer_38; }
    if ((token === import94.Sanitizer)) { return this._Sanitizer_39; }
    if ((token === import20.ViewUtils)) { return this._ViewUtils_40; }
    if ((token === import95.IterableDiffers)) { return this._IterableDiffers_41; }
    if ((token === import96.KeyValueDiffers)) { return this._KeyValueDiffers_42; }
    ...
    if ((token === import99.AppRootToken)) { return this._AppRootToken_53; }
    if ((token === import80.DeepLinkConfigToken)) { return this._DeepLinkConfigToken_54; }
    ...
    if ((token === import79.LocationStrategy)) { return this._LocationStrategy_63; }
    ...
    if ((token === import80.UrlSerializer)) { return this._UrlSerializer_73; }
    if ((token === import81.DeepLinker)) { return this._DeepLinker_74; }
    if ((token === import45.Storage)) { return this._Storage_75; }
    if ((token === import46.UserData)) { return this._UserData_76; }
    if ((token === import47.ConferenceData)) { return this._ConferenceData_77; }
